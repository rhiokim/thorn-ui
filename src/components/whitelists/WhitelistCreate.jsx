...
export default class WhitelistCreate extends React.Component {
  constructor() {
    super()
    ...
    return (
      <div className="panel panel-flat">
        <div className="panel-heading">
          <h5 className="panel-title">New Whitelist<a className="heading-elements-toggle"><i className="icon-more"></i></a></h5>
