...
export default class Rules extends React.Component {
  ruleMenu = (
    <Menu>
      <MenuItem iconName="add" text="View" onClick={this.handleClick.bind(this, 'new-wl')} />
      <MenuItem iconName="add" text="Edit" onClick={this.handleClick.bind(this, 'new-rule')}/>
      <MenuItem iconName="map" text="Copy Rule" onClick={this.handleClick.bind(this, 'new-wl')} />
      <MenuDivider />
      <MenuItem iconName="add" text="Deactivate" onClick={this.handleClick.bind(this, 'new-port')} />
      <MenuItem iconName="map" text="Delete" onClick={this.handleClick.bind(this, 'new-iptable')} />
    </Menu>
  )
